...
function switchSysBar(){
     if (1 == window.status){
		  window.status = 0;
          document.getElementById('switchPoint').innerHTML = '<img src="admin/Images/lere01.gif">';
          document.getElementById("frmleft").style.display="none"
     }
     else{
		  window.status = 1;
          document.getElementById('switchPoint').innerHTML = '<img src="admin/Images/lere.gif">';

<?php /* Smarty version Smarty-3.0.8, created on 2012-07-23 21:04:40
         compiled from "D:/www/bk/system/templates/default/list_product.html" */ ?>
<?php /*%%SmartyHeaderCode:29668500d4be819ae67-38338796%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11059c5bb6edf26e2ed97977ce98178446230f9e' => 
    array (
      0 => 'D:/www/bk/system/templates/default/list_product.html',
      1 => 1343048340,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '29668500d4be819ae67-38338796',
  'function' => 
  array (
  ),
...
<?php echo $_smarty_tpl->getVariable('pages')->value;?>
				...
				<div class="pro_erji">
                <!-- 右侧列表-->
				 <?php $_smarty_tpl->smarty->_tag_stack[] = array('loop', array('catid'=>$_smarty_tpl->getVariable('cat')->value['catid'],'pages'=>'page','rows'=>"4")); $_block_repeat=true; smarty_block_loop(array('catid'=>$_smarty_tpl->getVariable('cat')->value['catid'],'pages'=>'page','rows'=>"4"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
" /></a> <p><?php echo smarty_modifier_truncate_cn($_smarty_tpl->getVariable('r')->value['description'],70);?>
..</p> <h4><a href="<?php echo $_smarty_tpl->getVariable('r')->value['url'];?>
">More&gt;&gt;</a></h4></ul> 
					
					<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_loop(array('catid'=>$_smarty_tpl->getVariable('cat')->value['catid'],'pages'=>'page','rows'=>"4"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>

<?php /* Smarty version Smarty-3.0.8, created on 2012-07-25 12:49:53
         compiled from "E:/py163/qn200m/quanyuelong/web/system/templates/default/index.html" */ ?>
<?php /*%%SmartyHeaderCode:30902500f7af12b1522-27666198%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '68fde1b9143c109d2ee9e44f2734c3a55bf57fe2' => 
    array (
      0 => 'E:/py163/qn200m/quanyuelong/web/system/templates/default/index.html',
      1 => 1343191784,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '30902500f7af12b1522-27666198',
  'function' => 
  array (
  ),
...
<div class="longBg">
    ...
    <embed  wmode="transparent" src="uploadfile/flash.swf?bcastr_xml_url=uploadfile/flash.xml" quality="high" bgcolor="#869ca7"width="886" height="334" name="test" align="middle"play="true"loop="false"quality="high"allowScriptAccess="sameDomain"type="application/x-shockwave-flash"pluginspage="http://www.adobe.com/go/getflashplayer"></embed>
</object>
...
<div class="homeCon">
<!--<div class="news">
     <span style="top: 3px; left: 180px; position: relative;"><a href="/"><img src="<?php echo $_smarty_tpl->getVariable('image_path')->value;?>
		...
		<span class="block">
          ...
          <div class="homeMedia">
            ...
            <div class="homeMedia_L" style="width: 160px;">
           		...
           		<div class="homeMedia_Pic"><a href="index.php?m=content&c=index&f=show&catid=3&contentid=51"><img src="<?php echo $_smarty_tpl->getVariable('image_path')->value;?>
media_anybackup.jpg" border="0"></a></div>
              <div class="homeMedia_Con" style="width: 110px;"><a class="red" href="index.php?m=content&c=index&f=show&catid=3&contentid=51">北信云存储</a></div>
            </div>
			
            <div class="homeMedia_R">
            	<div class="homeMedia_Pic"><a href="index.php?m=content&c=index&f=show&catid=3&contentid=52"><img src="<?php echo $_smarty_tpl->getVariable('image_path')->value;?>
newconference.jpg" border="0"></a></div>
              <div class="homeMedia_Con"><a class="red" href="index.php?m=content&c=index&f=show&catid=3&contentid=52">数据挖掘</a></div>
            </div>
          </div>
          ...
          <div class="homeMedia">
            <div class="homeMedia_L" style="margin-top: 15px;">
              <div class="homeMedia_Pic"><a href="index.php?m=content&c=index&f=show&catid=38&contentid=37"><img src="<?php echo $_smarty_tpl->getVariable('image_path')->value;?>
media_2011exhi.jpg" border="0"></a></div>
              <div class="homeMedia_Con"><a href="index.php?m=content&c=index&f=show&catid=38&contentid=37">私有云解决方案</a></div>
            </div>              
            <div class="homeMedia_R" style="margin-top: 15px;">
              <div class="homeMedia_Pic"><a href="index.php?m=content&c=index&f=show&catid=38&contentid=54"><img src="<?php echo $_smarty_tpl->getVariable('image_path')->value;?>
media_cloud.jpg" border="0"></a></div><a href="/">
              </a><div class="homeMedia_Con"><a href="index.php?m=content&c=index&f=show&catid=38&contentid=54"></a><a href="/">虚拟化解决方案</a></div>
            </div>
          </div>

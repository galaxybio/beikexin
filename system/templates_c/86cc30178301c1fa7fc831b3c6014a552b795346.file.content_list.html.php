<?php /* Smarty version Smarty-3.0.8, created on 2012-07-21 09:12:53
         compiled from "D:/www/bk/system/templates/admin/content_list.html" */ ?>
<?php /*%%SmartyHeaderCode:401500a0215decb36-14541241%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '86cc30178301c1fa7fc831b3c6014a552b795346' => 
    array (
      0 => 'D:/www/bk/system/templates/admin/content_list.html',
      1 => 1339667450,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '401500a0215decb36-14541241',
  'function' => 
  array (
  ),
...
<tr>
    <th colspan=7 height=25><?php echo $_smarty_tpl->getVariable('catname')->value;?>
 内容列表</th>
</tr>
...
&nbsp;	  &nbsp;</td>
	<td height="25" colspan="6"><input name="submit" type="submit" class="inputs" value=" 删除 " onclick="form.action='index.php?m=91736&c=content&f=delete';" />&nbsp;	  &nbsp;<input name="submit2" type="submit" class="inputs" value=" 批量移动 " onclick="form.action='index.php?m=91736&c=transfer&f=transfer_content';" /></td>
  </tr>
<tr>
